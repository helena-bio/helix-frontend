...
export const docsSearchIndex: SearchEntry[] = [
  ...
  // AI Clinical Assistant
  {
    ...
    section: 'AI Clinical Assistant',
    content: 'AI clinical assistant Helix AI Qwen3-32B conversational intelligence natural language variant queries literature search clinical interpretation report generation PDF DOCX on-premise EU GDPR genomics knowledge phenotype-first analysis streaming SSE tool execution multi-turn conversation context window 20 messages Redis cache 24 hours',
  },
  {
    href: '/docs/ai-assistant/capabilities',
    title: 'Capabilities',
    section: 'AI Clinical Assistant',
    content: 'capabilities conversational variant analysis natural language SQL 2.3 million variants 70 columns literature search 1 million publications gene mentions variant mentions clinical interpretation diagnostic report PDF DOCX branded intelligent visualization ACMG pie chart chromosome bar gene scatter clinical knowledge ACMG AMP guidelines Mendelian inheritance gene-disease associations',
  },
  {
    href: '/docs/ai-assistant/asking-questions',
    title: 'Asking Questions',
    section: 'AI Clinical Assistant',
    content: 'asking questions effective interaction database query trigger variant data filtering aggregation phenotype-driven analysis candidate genes multi-turn conversation 20 messages follow-up context chained tool execution 5 rounds sequential SQL generation clinical terminology HGVS HPO ACMG gene symbols',
  },
  {
    href: '/docs/ai-assistant/clinical-interpretation',
    title: 'Clinical Interpretation',
    section: 'AI Clinical Assistant',
    content: 'clinical interpretation report generation four levels variants only screening-focused phenotype-focused full analysis adaptive depth structured template header AI body disclaimer data grounding hallucination prevention ACMG criteria evidence assessment inheritance mode genotype-phenotype correlation 2000 4000 words PDF DOCX export branded confidential validation clinical geneticist',
  },
  {
    href: '/docs/ai-assistant/database-queries',
    title: 'Database Queries',
    section: 'AI Clinical Assistant',
    content: 'database queries natural language SQL translation DuckDB patient variants classified 2.3 million 70 columns biomedical literature 1 million publications gene mentions variant mentions read-only 30 second timeout essential column filtering 20 columns token savings aggregation visualization suggestion query performance 200ms variant 500ms literature',
  },
]
