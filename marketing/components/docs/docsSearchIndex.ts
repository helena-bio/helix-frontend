...
export const docsSearchIndex: SearchEntry[] = [
  ...
  // AI Clinical Assistant
  {
    ...
    content: 'AI clinical assistant Helix AI conversational intelligence natural language variant queries literature search clinical interpretation report generation PDF DOCX on-premise EU GDPR genomics knowledge phenotype-first analysis streaming SSE tool execution multi-turn conversation context window 20 messages Redis cache 24 hours',
  },
  {
