...
export const metadata = {
  title: 'MetaSVM | Helena Documentation',
  description: 'MetaSVM predictor in Helena -- ensemble meta-predictor combining multiple pathogenicity tools. Displayed for clinical reference.',
}
