...
export const metadata = {
  title: 'Glossary | Helena Documentation',
  description: 'Definitions of key terms used throughout the Helena documentation -- ACMG criteria, genomics concepts, and platform-specific terminology.',
}

const terms = [
  { term: 'ACMG', definition: 'American College of Medical Genetics and Genomics. Publisher of the 2015 variant classification guidelines used by Helena.' },
  ...
  { term: 'AlphaMissense', definition: 'A protein structure-based pathogenicity predictor from DeepMind. Displayed for clinical reference in Helena but does not contribute to ACMG classification.' },
  { term: 'BayesDel_noAF', definition: 'The ClinGen SVI-calibrated computational meta-predictor used by Helena for PP3 and BP4 ACMG criteria. The "_noAF" suffix indicates allele frequency is excluded from its model.' },
  ...
  { term: 'BP4', definition: 'ACMG benign supporting criterion: computational evidence suggests no impact on gene or gene product. In Helena, triggered by BayesDel_noAF score <= -0.180.' },
  ...
  { term: 'ClinVar', definition: 'NCBI database of clinical significance assertions for genetic variants. Helena uses ClinVar for PS1, PP5, BP6 criteria and classification override.' },
  ...
  { term: 'DuckDB', definition: 'An in-process analytical database engine used by Helena for variant storage and querying. Each analysis session uses an isolated DuckDB file.' },
  ...
  { term: 'GRCh38', definition: 'Genome Reference Consortium Human Build 38 (hg38). The current standard human reference genome used by Helena.' },
  ...
  { term: 'PP3', definition: 'ACMG pathogenic supporting criterion: computational evidence supports a deleterious effect. In Helena, triggered by BayesDel_noAF or SpliceAI scores.' },
  ...
  { term: 'SpliceAI', definition: 'A deep learning model predicting splice site disruption. Produces four delta scores. Threshold >= 0.2 triggers PP3_splice in Helena.' },
  { term: 'VCF', definition: 'Variant Call Format. The standard file format for genomic variant data. Helena accepts VCF 4.1 and 4.2 files (plain text or bgzipped).' },
    ...
    <div className="py-10 space-y-6">
      <div>
        ...
        <p className="text-base text-muted-foreground leading-relaxed mt-3">
          Key terms used throughout the Helena documentation.
        </p>
      </div>
